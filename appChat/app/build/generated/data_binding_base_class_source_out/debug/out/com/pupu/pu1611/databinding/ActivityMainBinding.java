...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout container, @NonNull FloatingActionButton fabNewChat,
      @NonNull TabLayout myTabLayout, @NonNull ViewPager2 myViewPager,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.myViewPager;
      ViewPager2 myViewPager = ViewBindings.findChildViewById(rootView, id);
      if (myViewPager == null) {
        break missingId;
      }
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, container, fabNewChat,
          myTabLayout, myViewPager, searchView, toolbar);
    }
