...
public final class FragmentNotificationBinding implements ViewBinding {
  ...
  private FragmentNotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView rcNotification) {
  ...
  public static FragmentNotificationBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.rc_notification;
      RecyclerView rcNotification = ViewBindings.findChildViewById(rootView, id);
      if (rcNotification == null) {
        break missingId;
      }

      return new FragmentNotificationBinding((ConstraintLayout) rootView, rcNotification);
    }
